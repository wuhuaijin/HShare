...
def _load_model(checkpoint_path, device, precision, use_tp, channel_path):
...
def main(
    ...
    speculate_k: int = 5,
    batch_size: int = 1,
    channel_path: str = "../config/llama-2-7b-chat-hf/channel_top.json"
) -> None:
    ...
    print("Loading model ...")
    t0 = time.time()
    model = _load_model(checkpoint_path, device, precision, use_tp, channel_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--prompt', type=str, default="Please write an ending for the story of Little Red Riding Hood.", help='Input prompt.')
    ...
    parser.add_argument('--channel_path', type=str, default="../config/llama-2-7b-chat-hf/channel_top.json")

    args = parser.parse_args()
    main(
        args.prompt, args.interactive, args.num_samples, args.max_new_tokens, args.top_k,
        args.temperature, args.checkpoint_path, args.compile, args.compile_prefill, args.profile, args.draft_checkpoint_path, args.speculate_k, args.batch_size, args.channel_path
    )
